...
<body>
<form action="${pageContext.request.contextPath}/user/login.do" method="post" id="loginForm" style="padding:10px;">
	...
	<div class="form-group">
	   <button type="submit" class="form-control btn btn-primary btn-block">登录</button>
	    <button type="button" id="btn_register" class="form-control btn btn-primary btn-block">注册</button>
	</div>
</form>
</body>
</html>